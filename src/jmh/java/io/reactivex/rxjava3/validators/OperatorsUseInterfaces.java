...
public class OperatorsUseInterfaces {
            ...
            if (method.getDeclaringClass() == clazz) {
                ...
                for (Parameter param : method.getParameters()) {
                    ...
                    if (CLASSES.contains(type)) {
                        errors++;
                        error.append("Non-interface input parameter #").append(pidx).append(": ").append(type).append("\r\n").append("    ").append(method).append("\r\n");
                    }
                        ...
                        for (; ; ) {
                            ...
                            if (argType instanceof ParameterizedType) {
                                ...
                                if (CLASSES.contains(lastArg.getRawType())) {
                                    errors++;
                                    error.append("Non-interface lambda return #").append(pidx).append(": ").append(type).append("\r\n").append("    ").append(method).append("\r\n");
                                }
    ...
    static final Set<Class<?>> CLASSES = new HashSet<>(Arrays.asList(Flowable.class, Observable.class, Maybe.class, Single.class, Completable.class));
