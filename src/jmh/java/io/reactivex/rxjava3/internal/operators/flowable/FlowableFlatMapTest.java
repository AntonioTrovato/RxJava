...
public class FlowableFlatMapTest extends RxJavaTest {
    ...
    public void scalarInnerOuterOverflow() {
        ...
        }.flatMap(v -> Flowable.just(v), 1).test(0L).assertFailure(QueueOverflowException.class);
    }
    ...
    public void scalarInnerOuterOverflowSlowPath() {
        ...
        }).test().assertFailure(QueueOverflowException.class, 1);
    }
    ...
    public void innerFastPathEmitOverflow() {
        ...
        }, false, 1, 1).test(0L).assertFailure(QueueOverflowException.class);
    }
