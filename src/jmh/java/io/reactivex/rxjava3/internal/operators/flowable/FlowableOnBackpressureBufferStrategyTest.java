...
public class FlowableOnBackpressureBufferStrategyTest extends RxJavaTest {
    ...
    public void onDroppedNormalDropOldest() throws Throwable {
        ...
        TestSubscriber<Integer> ts = pp.onBackpressureBuffer(1, null, BackpressureOverflowStrategy.DROP_OLDEST, onDropped).test(0L);
        ts.assertEmpty();
        pp.onNext(1);
        ts.assertEmpty();
    ...
    public void onDroppedNormalDropLatest() throws Throwable {
        ...
        @SuppressWarnings("unchecked")
        Consumer<Integer> onDropped = mock(Consumer.class);
        TestSubscriber<Integer> ts = pp.onBackpressureBuffer(2, null, BackpressureOverflowStrategy.DROP_LATEST, onDropped).test(0L);
        ts.assertEmpty();
        pp.onNext(1);
        pp.onNext(2);
        ts.assertEmpty();
    ...
    public void onDroppedNormalError() throws Throwable {
        ...
        @SuppressWarnings("unchecked")
        Consumer<Integer> onDropped = mock(Consumer.class);
        TestSubscriber<Integer> ts = pp.onBackpressureBuffer(1, null, BackpressureOverflowStrategy.ERROR, onDropped).test(0L);
        ts.assertEmpty();
        pp.onNext(1);
        ts.assertEmpty();
        verify(onDropped, never()).accept(any());
    ...
    public void onDroppedCrash() throws Throwable {
        ...
        TestSubscriberEx<Integer> ts = pp.onBackpressureBuffer(1, null, BackpressureOverflowStrategy.DROP_OLDEST, onDropped).subscribeWith(new TestSubscriberEx<Integer>(0L));
        ts.assertEmpty();
        pp.onNext(1);
        ts.assertEmpty();
        pp.onNext(2);
