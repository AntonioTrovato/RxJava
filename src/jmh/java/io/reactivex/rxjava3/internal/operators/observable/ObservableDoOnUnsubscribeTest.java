...
public class ObservableDoOnUnsubscribeTest extends RxJavaTest {
    ...
    public void doOnUnsubscribe() throws Exception {
        ...
        Observable<Long> longs = Observable.// The stream needs to be infinite to ensure the stream does not terminate
        // before it is unsubscribed
        interval(50, TimeUnit.MILLISECONDS).doOnDispose(new Action() {
