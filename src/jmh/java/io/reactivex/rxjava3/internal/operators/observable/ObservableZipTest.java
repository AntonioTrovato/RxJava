...
public class ObservableZipTest extends RxJavaTest {
    ...
    @Test
    public void start() {
        Observable<String> os = OBSERVABLE_OF_5_INTEGERS.zipWith(OBSERVABLE_OF_5_INTEGERS, new BiFunction<Integer, Integer, String>() {
    ...
    @Test
    public void zip2() {
        Observable.zip(Observable.just(1), Observable.just(2), new BiFunction<Integer, Integer, Object>() {
    ...
    @Test
    public void zip3() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), new Function3<Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip4() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), new Function4<Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip5() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), Observable.just(5), new Function5<Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip6() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), Observable.just(5), Observable.just(6), new Function6<Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip7() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), Observable.just(5), Observable.just(6), Observable.just(7), new Function7<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip8() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), Observable.just(5), Observable.just(6), Observable.just(7), Observable.just(8), new Function8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip9() {
        Observable.zip(Observable.just(1), Observable.just(2), Observable.just(3), Observable.just(4), Observable.just(5), Observable.just(6), Observable.just(7), Observable.just(8), Observable.just(9), new Function9<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    public void zip2DelayError() {
        Observable.zip(Observable.just(1).concatWith(Observable.<Integer>error(new TestException())), Observable.just(2), new BiFunction<Integer, Integer, Object>() {
    ...
    public void zip2Prefetch() {
        Observable.zip(Observable.range(1, 9), Observable.range(21, 9), new BiFunction<Integer, Integer, Object>() {
    ...
    public void zip2DelayErrorPrefetch() {
        Observable.zip(Observable.range(1, 9).concatWith(Observable.<Integer>error(new TestException())), Observable.range(21, 9), new BiFunction<Integer, Integer, Object>() {
