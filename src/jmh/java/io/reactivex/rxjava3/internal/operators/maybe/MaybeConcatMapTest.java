...
public class MaybeConcatMapTest extends RxJavaTest {
    ...
    public void mainError() {
        Maybe.<Integer>error(new TestException()).concatMap(new Function<Integer, MaybeSource<Integer>>() {
    ...
    public void mainEmpty() {
        Maybe.<Integer>empty().concatMap(new Function<Integer, MaybeSource<Integer>>() {
