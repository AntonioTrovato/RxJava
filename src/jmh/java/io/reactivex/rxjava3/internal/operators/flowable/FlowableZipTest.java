...
public class FlowableZipTest extends RxJavaTest {
    ...
    public void zip2DelayError() {
        ...
        }, true).to(TestHelper.<Object>testConsumer()).assertFailure(CompositeException.class, "11", "22");
    ...
    public void zip2DelayErrorPrefetch() {
        ...
        }, true, 1).to(TestHelper.<Object>testConsumer()).assertFailure(CompositeException.class, "11", "22");
        List<Throwable> errors = TestHelper.compositeList(ts.errors().get(0));
        TestHelper.assertError(errors, 0, TestException.class, "One");
        TestHelper.assertError(errors, 1, TestException.class, "Two");
        assertEquals(2, errors.size());
    ...
    public void zip2Prefetch() {
        Flowable.zip(Flowable.range(1, 9), Flowable.range(21, 9), new BiFunction<Integer, Integer, Object>() {
    ...
    @Test
    public void zip2() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), new BiFunction<Integer, Integer, Object>() {
    ...
    @Test
    public void zip3() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), new Function3<Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip4() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), new Function4<Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip5() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), Flowable.just(5), new Function5<Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip6() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), Flowable.just(5), Flowable.just(6), new Function6<Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip7() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), Flowable.just(5), Flowable.just(6), Flowable.just(7), new Function7<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip8() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), Flowable.just(5), Flowable.just(6), Flowable.just(7), Flowable.just(8), new Function8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    @Test
    public void zip9() {
        Flowable.zip(Flowable.just(1), Flowable.just(2), Flowable.just(3), Flowable.just(4), Flowable.just(5), Flowable.just(6), Flowable.just(7), Flowable.just(8), Flowable.just(9), new Function9<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Object>() {
    ...
    public void singleErrorDelayed() {
        ...
        }, true).to(TestHelper.<Object>testConsumer());
    ...
    public void noCrossBoundaryFusion() {
        for (int i = 0; i < 500; i++) {
            TestSubscriber<List<Object>> ts = Flowable.zip(Flowable.just(1).observeOn(Schedulers.single()).map(new Function<Integer, Object>() {
    ...
    public void firstErrorPreventsSecondSubscription() {
        ...
        Flowable.zip(flowableList, new Function<Object[], Object>() {
    ...
    public void fusedInnerPollCrashDelayError() {
        Flowable.zip(Flowable.range(1, 5), Flowable.just(1).<Integer>map(v -> {
            throw new TestException();
        }).compose(TestHelper.flowableStripBoundary()), (a, b) -> a + b, true).test().assertFailure(TestException.class);
    }
    ...
    public void fusedInnerPollCrashRequestBoundaryDelayError() {
        Flowable.zip(Flowable.range(1, 5), Flowable.just(1).<Integer>map(v -> {
            throw new TestException();
        }).compose(TestHelper.flowableStripBoundary()), (a, b) -> a + b, true).test(0L).assertFailure(TestException.class);
    }
}
