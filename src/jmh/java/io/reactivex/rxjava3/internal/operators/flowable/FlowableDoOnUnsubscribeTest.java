...
public class FlowableDoOnUnsubscribeTest extends RxJavaTest {
    ...
    public void doOnUnsubscribe() throws Exception {
        ...
        Flowable<Long> longs = Flowable.// The stream needs to be infinite to ensure the stream does not terminate
        // before it is unsubscribed
        interval(50, TimeUnit.MILLISECONDS).doOnCancel(new Action() {
