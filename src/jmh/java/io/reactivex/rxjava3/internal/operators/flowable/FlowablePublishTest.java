...
public class FlowablePublishTest extends RxJavaTest {
    ...
    public void overflowQueue() {
        ...
        try {
            ...
            }, BackpressureStrategy.MISSING).publish(8).autoConnect().test(0L).// 3.x emits errors last, even the full queue errors
            requestMore(10).assertFailure(QueueOverflowException.class, 0, 1, 2, 3, 4, 5, 6, 7);
    ...
    public void overflowQueueRefCount() {
        ...
        }.publish(1).refCount().test(0).requestMore(1).assertFailure(QueueOverflowException.class, 1);
    }
