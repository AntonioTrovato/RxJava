...
public class FlowableFromCompletableTest extends RxJavaTest {
    ...
    public void fromCompletableTwice() {
        ...
        Flowable.fromCompletable(Completable.fromAction(run)).test().assertResult();
        assertEquals(1, atomicInteger.get());
        Flowable.fromCompletable(Completable.fromAction(run)).test().assertResult();
    ...
    public void disposedUpfront() throws Throwable {
        ...
        Flowable.fromCompletable(Completable.fromAction(run)).test(1L, true).assertEmpty();
    ...
    public void asyncFused() throws Throwable {
        ...
        Flowable.fromCompletable(Completable.fromAction(action)).subscribe(ts);
