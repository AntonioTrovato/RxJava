...
public class ObservablePublishTest extends RxJavaTest {
    ...
    public void selectorLatecommer() {
        Observable.range(1, 5).publish(new Function<Observable<Integer>, ObservableSource<Integer>>() {
    ...
    public void doubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservable(new Function<Observable<Object>, ObservableSource<Object>>() {
            ...
            @Override
            public ObservableSource<Object> apply(final Observable<Object> o) throws Exception {
    ...
    public void disposedUpfront() {
        ConnectableObservable<Integer> co = Observable.just(1).concatWith(Observable.<Integer>never()).publish();
    ...
    public void altConnectRace() {
        for (int i = 0; i < TestHelper.RACE_LONG_LOOPS; i++) {
            final ConnectableObservable<Integer> co = new ObservablePublish<>(Observable.<Integer>never());
